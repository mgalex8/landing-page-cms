            ...
            <table class="table table-striped table-hover" id="user-table">
                <thead>
                    <tr>
                        ...
                        <th class="span4"><?php echo __('Text'); ?></th>                        
                        <th class="span2"></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td class="text-center"><input type="checkbox" name="delete[<?php echo  $position['id']; ?>]" item-id="<?php echo $position['id']; ?>" /></td>                                                        
                            <td><?php echo $position['name']; ?></td>
                            <td><?php echo $position['title']; ?></td>
                            <td><?php echo $position['text']; ?></td>
                            <td class="text-center">
                                <a class="btn btn-success" href="<?php echo $result['edit_url']; ?>?id=<?php echo  $position['id'] ;?>"><i class="icon-pencil icon-white"></i></a>        
                                <a class="btn btn-danger remove-image-btn" item-id="<?php echo $position['id']; ?>"><i class="icon-remove icon-white"></i></a>
                            </td>
                        </tr>
                    <?php
                    }
