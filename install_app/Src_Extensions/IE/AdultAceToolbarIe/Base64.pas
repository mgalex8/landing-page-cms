...
uses SysUtils;
  ...
  // codiert einen String in die zugeho"rige Base64-Darstellung
  function Base64Encode(const InText: AnsiString): AnsiString; overload;
  // decodiert die Base64-Darstellung eines Strings in den zugeho"rigen String
  function Base64Decode(const InText: AnsiString): AnsiString; overload;

  // bestimmt die Gro"?e der Base64-Darstellung
  function CalcEncodedSize(InSize: Cardinal): Cardinal;
  // bestimmt die Gro"?e der bina"ren Darstellung
  function CalcDecodedSize(const InBuffer; InSize: Cardinal): Cardinal;

  // codiert einen Buffer in die zugeho"rige Base64-Darstellung
